...
void testApp::setup(){
    ...
    buffer->loadMovieAsync("fingers.mov");
    buffers.push_back(buffer);
    
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("bball.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("countdown.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("dishes.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("crashtest.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("countdown15.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("dozer.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("dvkite.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("dvducks.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("garbage.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("oh.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("ozone.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("rain.mov");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("IMG_0004.JPG");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("IMG_0003.JPG");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("IMG_0005.JPG");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("IMG_0006.JPG");
    buffers.push_back(buffer);
    buffer = ofxSharedVideoBuffer(new ofxVideoBuffer());
    buffer->loadMovieAsync("IMG_0007.JPG");
    buffers.push_back(buffer);
